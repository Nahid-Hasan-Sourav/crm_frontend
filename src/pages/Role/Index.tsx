...
const Index = () => {
  ...
  const rows = [
    { Id:"1",Role: "Managers",Permissions:"division.create,division.update,division.delete"},
    { Id:"2",Role: "Administrator",Permissions:"division.create,division.update,division.delete" },
    { Id:"3",Role: "Customer",Permissions:"division.create,division.update,division.delete" },
    { Id:"4",Role: "User",Permissions:"division.create,division.update,division.delete"},
  ];
